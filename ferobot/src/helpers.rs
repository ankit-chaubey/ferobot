...
impl InaccessibleMessage {
    ...
    /// # Example
    /// ```rust,no_run
    /// # use ferobot::types::{InaccessibleMessage};
    ...
    pub fn to_message(&self) -> Message {
        ...
        serde_json::from_value(v).expect("InaccessibleMessage to Message: mandatory fields missing")
    }
}
