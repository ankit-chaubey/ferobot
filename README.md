...
[![Coverage](https://img.shields.io/badge/API%20Coverage-100%25-22c55e?style=flat-square)](https://github.com/ankit-chaubey/ferobot/actions)
[![Downloads](https://img.shields.io/crates/d/ferobot?style=flat-square&color=f97316&label=Downloads)](https://crates.io/crates/ferobot)
...
[📦 Install](#-installation) · [🚀 Quick Start](#-quick-start) · [📖 Examples](#-examples) · [🔧 API Reference](#-api-reference) · [🔄 Auto-Codegen](#-auto-codegen) · [📚 docs.rs](https://docs.rs/ferobot)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
 ...
 let msg = bot.send_message(123456789i64, "Hello from ferobot! 🦀", None).await?;
...
let keyboard = InlineKeyboardMarkup {
 ...
 text: "✅ Accept".into(),
 callback_data: Some("accept".into())..Default::default()
 },
 InlineKeyboardButton {
 text: "❌ Decline".into(),
 callback_data: Some("decline".into())..Default::default()
 },
 ],
 ],
};
...
```rust
use ferobot::{ReplyMarkup, gen_methods::SendMessageParams};
use ferobot::types::{KeyboardButton, ReplyKeyboardMarkup};
...
let keyboard = ReplyKeyboardMarkup {
 ...
 request_location: Some(true)..Default::default()
 },
 KeyboardButton {
 text: "📱 Share Contact".into(),
 request_contact: Some(true)..Default::default()
 },
 ],
 ],
 resize_keyboard: Some(true),
 one_time_keyboard: Some(true)..Default::default()
};
...
```rust
use ferobot::{InputFile, gen_methods::SendPhotoParams};
...
```rust
use ferobot::InputMedia;
use ferobot::types::{InputMediaPhoto, InputMediaVideo};

let media = vec![
 InputMedia::Photo(InputMediaPhoto {
 r#type: "photo".into(),
 media: "AgACAgIAAxkBAAI...".into(),
 caption: Some("First photo 📸".into())..Default::default()
 }),
 InputMedia::Video(InputMediaVideo {
 r#type: "video".into(),
 media: "BAACAgIAAxkBAAI...".into(),
 caption: Some("A video 🎬".into())..Default::default()
 }),
];
...
use ferobot::types::InputPollOption;
...
let results = vec![
 ...
 message_text: "Hello from inline mode! 👋".into()..Default::default()
 }),
 description: Some("Send a greeting".into())..Default::default()
 }),
];
...
```rust
use ferobot::types::LabeledPrice;
...
`ferobot` supports two webhook approaches: a **built-in server** (zero boilerplate) or a **manual setup** using your own HTTP framework.
...
use std::sync::Arc;
use ferobot::{gen_methods::SetWebhookParams, types::Update, Bot};
...
See [`examples/webhook/`](https://github.com/ankit-chaubey/ferobot/tree/main/examples/webhook) for a full working example with `.env` configuration.
...
ferobot automatically stays in sync with the official API. The spec is sourced from **[tgapis/x](https://github.com/tgapis/x/tree/data)**, which scrapes the official Telegram Bot API page every 6 hours. When a new version is detected, regeneration kicks off immediately.
...
**Report issues:**
- 🐛 Bug: [open a bug report](https://github.com/ankit-chaubey/ferobot/issues/new?template=bug_report.md)
- 💡 Feature: [open a feature request](https://github.com/ankit-chaubey/ferobot/issues/new?template=feature_request.md)
- 🔒 Security: email [ankitchaubey.dev@gmail.com](mailto:ankitchaubey.dev@gmail.com) directly

**Development workflow:**

```sh
git clone https://github.com/ankit-chaubey/ferobot && cd ferobot
...
python3 .github/scripts/validate_generated.py \
 api.json ferobot/src/gen_types.rs ferobot/src/gen_methods.rs
```
...
**ferobot** was built and is maintained by [Ankit Chaubey](https://github.com/ankit-chaubey).
...
<p align="center">
 <a href="https://docs.rs/ferobot">
 <img src="https://img.shields.io/badge/docs.rs-ferobot-4a90d9?style=flat-square&logo=docs.rs" />
 </a>
 <a href="https://crates.io/crates/ferobot">
 <img src="https://img.shields.io/badge/crates.io-ferobot-f74c00?style=flat-square&logo=rust" />
 </a>
 <a href="https://github.com/ankit-chaubey/ferobot/stargazers">
 <img src="https://img.shields.io/github/stars/ankit-chaubey/ferobot?style=social" />
 </a>
</p>
...
*If ferobot saved you time, a ⭐ on GitHub means a lot!*
